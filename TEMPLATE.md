...
- Версия: `1.1.1`.
- Тег исходников этой версии: `v1.1.1`.
- Набор файлов для `main` собирается только из проверенного тега `v1.1.1`.
- Теги `v1.0.0`, `v1.0.1` и `v1.1.0` сохраняются без изменений.
...
Сборка выполняется после прямого разрешения на выпуск. Она требует неизмененного состояния исходников, соответствующего тегу `v1.1.1`, совпадения версии и адреса репозитория:
